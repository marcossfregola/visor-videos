...
- **Fecha:** 2026-08-21
- **Tipo:** implementación técnica de **B6.10 completada, probada y validada manualmente; cerrada documental, técnica y en Git en este commit** (commit de cierre en `beta6`; sin tag/merge/release; sin B6.11).
- **Rama:** `beta6`.
