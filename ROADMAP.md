...
**B8.1 — Preparación de identidad** (agregar `ruta_normalizada`, helper central, poblarla, `UNIQUE(ruta_normalizada)`, dual-write, mantener `UNIQUE(nombre)`, reordenar pipeline).
