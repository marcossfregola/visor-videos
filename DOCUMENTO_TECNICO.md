...
├── nombres.py             Motor general y reutilizable de nombres (B6.8): componente puro/testeable separado de UI/SQLite/FFmpeg/PySide6; tokens cerrados, sanitizacion Windows, extension controlada, colisiones deterministas
