...
# 1 Default Vista=Dinámica 0 widgets — B9.5 adaptación: combo ahora tiene 4 (Dinámica/Tira/Reducida/Ajustada) sin relajar resto
def test_01_default_dinamica():
    ...
    try:
        ...
        pass
    # Ajustada también oculta por defecto
    try:
